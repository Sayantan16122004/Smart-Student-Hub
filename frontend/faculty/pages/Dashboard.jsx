...
const ClipboardIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <rect x="5" y="4" width="14" height="17" rx="2" /><path d="M9 3h6v3H9z" /><path d="M9 12h6M9 16h6" />
  </svg>
);
const StarIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M12 2l3 7 7 .6-5.3 4.6L18.2 22 12 18.2 5.8 22l1.5-7.8L2 9.6 9 9z" />
  </svg>
);
const ClockIcon = () => (
...
const UserPlusIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <circle cx="9" cy="8" r="4" /><path d="M2 20c0-3.9 3.1-7 7-7s7 3.1 7 7" /><path d="M19 8v4M17 10h4" />
  </svg>
);
const CheckBadgeIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <circle cx="12" cy="9" r="5" /><path d="M8 14l-2 7 6-3 6 3-2-7" /><path d="M9.5 9l1.5 1.5L14.5 7" />
  </svg>
);
...
const QuoteIcon = () => (
  <svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor">
    <path d="M9 7C5.7 7 3 9.7 3 13c0 2.8 2 5.1 4.6 5.6L9 21l-.9-2.1C9.9 18.1 11 16.2 11 14V9c0-1.1-.9-2-2-2zm10 0c-3.3 0-6 2.7-6 6 0 2.8 2 5.1 4.6 5.6L19 21l-.9-2.1c1.8-.8 2.9-2.7 2.9-4.9V9c0-1.1-.9-2-2-2z" />
  </svg>
);
...
const STATS = [
  ...
  { label: "Attendance Rate", value: "92%", change: "+5%", icon: ClipboardIcon, accent: "emerald" },
